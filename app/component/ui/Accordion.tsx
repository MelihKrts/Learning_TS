...
//             content: "TypeScript öğrenirken aldığım notlardır. Github üzerinden not alırken yararlanılan kaynaklar olmak üzere paylaşılmıştır. Daha efektif ve gelişmiş şekilde bu websitesinde paylaşma amacı taşımaktadır. Not aldığım bilgilerde eksiklik vs varsa Github üzerinden katkı verebilirsinz",
//         },
//
//         {
//             id: "repo-içerik",
...
//
//     return (
//         <div className="container min-h-dvh flex justify-center items-center flex-col mx-auto">
//             <div className="w-full text-center mt-4 flex flex-row justify-center items-center">
//                 <Image src="/logos/TS_Logo.svg" alt="TypeScript Logo" priority width={50} height={50}/>
//                 <h3 className="text-2xl px-4 py-2">Learn TS</h3>
//             </div>
//             {accorData.map((item, index) => (
//                 <div key={index} onClick={() => toggle(item.id)}
//                      className="max-w-1/2 min-w-3/4 bg-teal-200 my-4 rounded-md">
//                     <div className="flex justify-between items-center">
//                         <h3 className="bold-title py-2 px-4">
//                             {item.title}
//                         </h3>
//                         {open ? <FaAngleUp className={`transition-transform duration-300 mx-4`}/> : <FaAngleDown className="mx-4"/>}
//
//                     </div>
//
//                     {open === item.id && (
                ...
                {accorData.map((item, index) => (
                    <div key={item.id}
                        ...
                        >
                            ...
                            <div className="ml-4 p-2 rounded-full bg-white shadow-sm group-hover:bg-blue-100 transition-all duration-300">
                                {open === item.id ?
