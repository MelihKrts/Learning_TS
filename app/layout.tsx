...
export default function RootLayout({children,}: Readonly<{
    ...
    return (
        ...
        {/* iPhone 6, 7, 8 */}
        <link rel="apple-touch-startup-image" href="/ios-splash-img/ip6.png" media="screen(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2)
  and (orientation: portrait)"/>
        ...
        <link rel="apple-touch-startup-image" href="/ios-splash-img/ipXR.png"
              media="screen (device-width: 414px) and (device-height: 896px) and(-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
        />

        {/* iPhone XS Max, 11 Pro Max */}
        <link rel="apple-touch-startup-image" href="/ios-splash-img/ipX-XII.png"
              media="screen (device-width: 414px) and (device-height: 896px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)"
        />

        {/* iPhone 12, 13, 14, 16 (standart modeller) */}
        <link rel="apple-touch-startup-image" href="/ios-splash-img/ipXII-XIV.png"
              media="screen (device-width: 390px) and (device-height: 844px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)"
        />

        {/* iPhone 14 Plus, 14 Pro Max, 15 Pro Max, 16 Plus */}
        <link rel="apple-touch-startup-image" href="/ios-splash-img/ipXIV-XVI.png"
              media="screen (device-width: 428px) and (device-height: 926px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)"
        />

        {/* iPhone 14 Pro, 15 Pro, 16 Pro */}
        <link rel="apple-touch-startup-image" href="/ios-splash-img/ipXIV-XVIpro.png"
              media="screen (device-width: 430px) and (device-height: 932px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)"
        />

        {/* iPhone 16e */}
        <link rel="apple-touch-startup-image" href="/ios-splash-img/ip16e.png"
              media="screen (device-width: 430px) and (device-height: 932px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
        />
